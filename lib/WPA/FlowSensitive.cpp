...
void FlowSensitive::printCTirAliasStats(void)
{
    ...
    Set<NodeIDPair,pair_hash<NodeIDPair>> cmpLocs;
...
void FlowSensitive::countAliases(Set<std::pair<NodeID, NodeID>, pair_hash<std::pair<NodeID, NodeID>>> cmp, unsigned *mayAliases, unsigned *noAliases)
{
